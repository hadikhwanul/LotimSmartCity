...
<main id="main" class="clearfix">
    ...
    <section id="dimensi" class="m-auto">
        ...
        <div class="row justify-content-center">
            @foreach ($Branding as $sg)
            <div class="col-md-6 col-lg-4" >
                <div class="box">
                    <a href="/Smart-Branding/{{ $sg->slug }}">
                        <div class="icon"><i class="bi bi-hdd-rack" style="color: #ff689b;"></i></div>
                        <h5 class="title"><a href="/Smart-Branding/{{ $sg->slug }}">{{ $sg->portal }}</a></h5>
                        <div class="row col-md-4 col-lg-3 align-items-between d-inline">
                            <div class="title demo-inline-spacing">
                                <a href="/Smart-Branding/{{ $sg->slug }}" class=" btn btn-primary text-light">Detail</a>
                                @if ($sg->status === "Active")
