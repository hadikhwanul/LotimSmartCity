    ...
    <section id="dimensi" class="m-auto">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="box">
                    <a href="/Smart-Environment/{{ $se->slug }}">
                        <div class="icon"><i class="bi bi-hdd-rack" style="color: #ff689b;"></i></div>
                        <h5 class="title"><a href="/Smart-Environment/{{ $se->slug }}">{{ $se->portal }}</a></h5>
                        <div class="row col-md-4 col-lg-3 align-items-between d-inline">
                            <div class="title demo-inline-spacing">
                                <a href="/Smart-Environment/{{ $se->slug }}" class=" btn btn-primary text-light">Detail</a>
                                @if ($se->status === "Active")
