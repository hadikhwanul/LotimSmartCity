...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class=" buy-now ">
        <a href="/Admin-SmartEnvironment" class="btn btn-danger btn-buy-now" style="align-items: flex-end;"><i
    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/Admin-SmartEnvironment/{{$Environment->slug}}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('portal') is-invalid @enderror"
                                    id="portal" name="portal" value="{{ $Environment->portal, old('portal') }}" required />
                                @error('portal')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                    name="slug" value="{{ $Environment->slug, old('slug') }}" required />
                                @error('slug')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <input type="text" id="basic-default-email"
                                        ...
                                        value="{{ $Environment->alamat, old('alamat') }}" required />
                                    @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="basic-default-phone"
                                    ...
                                    value="{{ $Environment->link, old('link') }}" required />
                                @error('link')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select id="Status" name="status" class="form-select defaultSelect" required>
                                    <option value="Active"
                                        {{ (old('status', $Environment->status) == 'Active') ? 'selected' : '' }}>
                                        Active
                                    </option>
                                    <option value="Deactive"
                                        {{ (old('status', $Environment->status) == 'Deactive') ? 'selected' : '' }}>
                                        Deactive
                                    </option>
                                </select><br>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control @error('logo_se') is-invalid @enderror" type="file"
                                        id="formFile" name="logo_se" value="{{$Environment->logo_se, old('logo_se') }}" />
                                    @error('logo_se')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input id="deskripsi" type="hidden" name="deskripsi"
                                        value="{{ $Environment->deskripsi, old('deskripsi') }}">
