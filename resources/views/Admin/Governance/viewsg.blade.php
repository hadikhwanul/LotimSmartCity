                ...
                <div class="card mb-3">
                    <div class="row g-0">
                        <div class="col-md-4">
                            ...
                            <img src="{{ asset('storage/'.$governance->logo_sg) }}" class="card-img card-img-left mt-5"
                                alt="" style="max-height: auto; overflow: hidden;">
                            @else
                            <img src="https://source.unsplash.com/1080x720?random" class="img-fluid mt-3" alt="">
                            @endif
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>
                                        {{$governance->category->nama }}</strong>
                                </p>
                                <p class="card-text"><strong>
                                ...
                                <p class="card-text"><strong><a href="{{ $governance->link }}">Link :
                                    </strong>{{ $governance->link }}</a></p>
