    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/Admin-CategorySmartGovernance/{{ $category->slug }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    id="portal" name="nama" value="{{$category->nama, old('nama') }}" required />
                                @error('nama')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                    name="slug" value="{{$category->slug, old('slug') }}" required/>
                                @error('slug')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
