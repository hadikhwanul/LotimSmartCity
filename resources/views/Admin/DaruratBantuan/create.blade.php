    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/Admin-DaruratBantuan" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control @error('logo_db') is-invalid @enderror" type="file"
                                    id="formFile" name="logo_db" value="{{ old('logo_bd') }}" />
                                @error('logo_db')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
