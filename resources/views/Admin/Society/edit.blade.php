    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/Admin-SmartSociety/{{$society->slug}}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('portal') is-invalid @enderror"
                                    id="portal" name="portal" value="{{ $society->portal, old('portal') }}" required />
                                @error('portal')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                    name="slug" value="{{ $society->slug, old('slug') }}" required />
                                @error('slug')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <input type="text" id="basic-default-email"
                                        ...
                                        value="{{ $society->alamat, old('alamat') }}" required />
                                    @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="basic-default-phone"
                                    ...
                                    value="{{ $society->link, old('link') }}" required />
                                @error('link')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select id="Status" name="status" class="form-select defaultSelect" required>
                                    <option value="Active"
                                        {{ (old('status', $society->status) == 'Active') ? 'selected' : '' }}>
                                        Active
                                    </option>
                                    <option value="Deactive"
                                        {{ (old('status', $society->status) == 'Deactive') ? 'selected' : '' }}>
                                        Deactive
                                    </option>
                                </select><br>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control @error('logo_sc') is-invalid @enderror" type="file"
                                        id="formFile" name="logo_sc" value="{{$society->logo_sc, old('logo_sc') }}" />
                                    @error('logo_sc')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input id="deskripsi" type="hidden" name="deskripsi"
                                        value="{{ $society->deskripsi, old('deskripsi') }}">
