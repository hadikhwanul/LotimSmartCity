...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class=" buy-now ">
        <a href="/Admin-TagAgenda" class="btn btn-danger btn-buy-now" style="align-items: flex-end;"><i
    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/Admin-TagAgenda/{{ $tagAgenda->slug }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    id="portal" name="nama" value="{{$tagAgenda->name, old('name') }}" required />
                                @error('nama')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                    name="slug" value="{{$tagAgenda->slug, old('slug') }}" required/>
                                @error('slug')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
