    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/Admin-Agenda/{{$Agenda->slug}}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="portal"
                                    name="title" value="{{$Agenda->title, old('title') }}" required />
                                @error('title')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                    name="slug" value="{{$Agenda->slug, old('slug') }}" required />
                                @error('slug')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-phone">Tag Agenda</label>
                            <div class="col-sm-10 mb-3">
                                <select id="tag_id" name="tag_id" class="form-select form-select-lg" required>
                                    <option value="" class="text-center">Pilih Tag Agenda</option>
                                    @foreach ($tag as $tags)
                                    <option value="{{ $tags->id }}"
                                        {{ ( old('tag_id', $Agenda->tag_id) == $tags->id ? 'selected' : '') }}>
                                        {{ $tags->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-message">Agenda</label>
                            <div class="col-sm-10">
                                <input id="body" type="hidden" name="body" value="{{ $Agenda->body, old('body') }}">
