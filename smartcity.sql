...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2024 at 03:35 AM
...
INSERT INTO `brandings` (`id`, `portal`, `link`, `status`, `logo_sb`, `published_it`, `created_at`, `updated_at`) VALUES
(1, 'Diskominfo Lotim', 'https://diskominfo.lomboktimurkab.go.id/', 'Active', 'kominfo.jpg\r\n', NULL, NULL, NULL),
(2, 'Pemkab Lotim', 'https://portal.lomboktimurkab.go.id/', 'kosong', 'lotim.jpg', NULL, NULL, NULL);
